...
echo '<div class="container item" data-id="'.$moduleinstance->content.'"><div class="row d-flex justify-content-center"><div class="col-md-2"><button style="color:#174c8d;background-color:white;border-color:#4285f4;" class="btn btn-lg btn-info" data-action="book_modal" >Открыть</button></div></div></div>';
